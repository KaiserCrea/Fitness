const CACHE = "fitness-v24-25-10-correctifs-valides-1";
...
self.addEventListener("install", event => {
  event.waitUntil((async () => {
    ...
    await cache.addAll(["./", "./index.html", "./app.js?v=242510", "./app.css?v=242510", "./data.js?v=24240", "./sheet-layouts.js", "./thumbnail-map.js?v=24253"]);
