const CACHE = "fitness-v24-25-9-correctifs-cibles-20260923-1";
...
self.addEventListener("install", event => {
  event.waitUntil((async () => {
    ...
    await cache.addAll(["./", "./index.html", "./app.js?v=24259", "./app.css?v=24259", "./data.js?v=24240", "./sheet-layouts.js", "./thumbnail-map.js?v=24253"]);
